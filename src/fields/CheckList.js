...
import {Button, CheckList, NavBar, Popup} from "@kne/antd-taro";
import withDecoratorList from '../common/withDecoratorList';

const CheckListPopup = ({
                            value, open, onClose, placeholder, onChange, options, children, ...props
                        }) => {
    ...
    return <Popup bodyClassName="react-form__popup" open={open} onClose={closeHandler} position="right">
